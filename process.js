const API_URL = "https://xw6r7jyz52.execute-api.us-east-1.amazonaws.com/dev";
const PHOTOGALLERY_S3_BUCKET_URL = "photobucket-deen-2024-4150";
...
// function deletePhoto - Ashan
function photo_delete(PhotoID){
    console.log("in photo_delete!!")
     $.ajax({
...
$('#portfolio-4-col-grid').on('click', '#home_delete', function(e) {
    ...
    photo_delete($this.data('photoid'));
})
